...
<Image
  src={robofriends}
  alt="A React project that searches through a list of robots generated from the RoboHash API"
/>
...
_See the live project <a href="https://dmcdaniel90.github.io/robofriends/" target="_blank">here</a>_

_See the Github repo <a href="https://github.com/dmcdaniel90/robofriends" target="_blank">here</a>_
...
- API: <a href="https://robohash.org/" target="_blank">RoboHash API</a> for generating robot images based on text.
